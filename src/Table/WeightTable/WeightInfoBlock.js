...
import styles, { TextColor, BorderColor } from '../RenderItem/renderItemStyles.js'
...
export default function WeightInfoBlock({ currentDayData, editingCell, setEditingCell, index, flatListRef, mode, maxId }) {
    let i = 0;
